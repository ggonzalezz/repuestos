...
//Función para cerrar registros
function anular(idventa)
{
	bootbox.confirm("¿Está Seguro de Cerrar la Venta?", function(result){
		if(result)
        {
...
function desactivar(idventa)
{
	bootbox.confirm("¿Está Seguro de anular la Venta?", function(result){
		if(result)
        {
        	$.post("../ajax/venta.php?op=desactivar", {idventa : idventa}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});
        }
