...
Class Consultas
{
	...
	{
		$sql="SELECT DATE(i.fecha_hora) as fecha,u.nombre as usuario, p.nombre as proveedor,i.tipo_comprobante,i.serie_comprobante,i.num_comprobante,i.total_compra,i.estado FROM ingreso i INNER JOIN persona p ON i.idproveedor=p.idpersona INNER JOIN usuario u ON i.idusuario=u.idusuario WHERE DATE(i.fecha_hora)>='$fecha_inicio' AND DATE(i.fecha_hora)<='$fecha_fin'";
    ...
    public function reporteporfecha($idcategoria,$fecha_inicio,$fecha_fin)
	{
...
where  c.idcategoria='$idcategoria' and v.con >='$fecha_inicio' and v.con <='$fecha_fin'
...
public function reporteporfechaNoAdmin($idcategoria,$fecha_inicio,$fecha_fin)
	{
